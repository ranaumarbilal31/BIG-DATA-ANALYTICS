...
| Name | Student ID |
| :--- | :--- |
| **Rana Umar Bilal** | 2023-ag-10136 |
| **Husnain Tayyab** | 2023-ag-10067 |
| **Rabeet Ahmad** | 2023-ag-10134 |
| **Tayyab Tahir** | 2023-ag-10152 |
...
| :--- | :--- | :--- |
| 📁 **[Task 1](./Task_1_Environment_Setup)** | **Environment Setup** | Cloud IDE initialization and library verification (`pandas`, `numpy`, `matplotlib`). |
| 📁 **[Task 2](./Task_2_Python_Fundamentals)** | **Python Fundamentals** | Data structures, error handling, and CSV/JSON file operations. |
...
## 🛠️ Key Competencies Demonstrated
<details>
  <summary><b>Click to expand full skill list</b></summary>
